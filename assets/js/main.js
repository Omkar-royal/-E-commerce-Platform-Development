              ...
              <td class='' style='width: 30px'> 
                          ...
                          <div class="control__indicator"></div>
                            ...
                            <div class="d-flex">
                                ...
                                height="50px"
                            /> </div>
                               <div class=''><span id="title" class="fs-6 ytd-compact-video-renderer " aria-label="${product.title}" title="${product.title}">
                           ${product.title}     </span>
                           <span  class="fs-6 fw-normal ytd-compact-video-renderer " aria-label="${product.description}" title="${product.description}">
                           ${product.description}     </span>  </div>
                            ...
                            <td class='text-secondary fs-6 fw-bold'   >&nbsp; &nbsp ${Math.floor((Math.random() * 100) + 1)}</td>
                            <td class='text-secondary fs-6 fw-bold' >UK${Math.floor((Math.random() * 10000) + 1)}
                            </td>
                            <td class='text-warning'  >
                              
                                ${stars(product.rating.rate)} <span class='text-secondary'>(${product.rating.count})</span>
                            </td>
                            <td>
                                <button class="btn  icon-bg-color fw-bold text-dark d-none d-lg-inline" data-bs-toggle='modal'
...
temp=val;
  for(let i=1;i<=5;i++){
    if(Math.floor(temp)!=0){
      t+=`<i class="bi bi-star-fill"></i>`;
      temp--;
    }else if(Math.round(temp)!=0) {
      t+=`<i class="bi bi-star-half text-warning"></i>`;
      temp=0;
    } else {
      t+=`<i class="bi bi-star text-secondary"></i>`;
    }
  }
  return t;
